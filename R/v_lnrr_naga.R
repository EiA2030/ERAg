#' @title v_lnrr_naga
#' @description Calculates the sampling variance for log response ratio based on second order Taylor expansion proposed by Lajeunesse 2011 as per equation 7 of Nagakawa 2022
...
#' @export
v_lnrr_naga<-function(n1,n2,n1_data,n2_data,CV1_data,CV2_data){
