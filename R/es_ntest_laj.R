#' es_ntest_laj
#' Calculates % of effect sizes that fail Lajeunesse's (2015) test for assumption of normality. The accuracy of the sampling variance for lnRR depends on whether lnRR is normally distributed.
