...
Agroclimatology datasets such as POWER contain the variables needed to calculate PET, but before we can do this we need to add altitude and gap fill some missing solar radiation values.  
