...
6. If argument `Do.BioClim==T` then:
  + Annual bioclimatic values are calculated using the \link[dismo]{biovars} function for each complete year of data in `CLIMATE` per unique locationas (`ID` field) in `DATA`. The output data is return as [[Annual.BioClim]][[Annual.Estimates]]`;
