...
5) **`SubPrName`** = (experimental) subpractice name  (*note that this corresponds to the Subpractice.S field in the PracticeCodes*)
6) **`SubPrName.Code`** = (experimental) subpractice name code  
7) **`SubPrName.Base`** = base practice name (*note that this corresponds to the Subpractice.S field in the PracticeCodes*)
...
```{r Other Datasets, echo=T, warning=FALSE}
 knitr::kable(ERA_Other_Linked_Data_Fields$Dataset_Descriptions[-(1:4),c("Name","Description")])
```
